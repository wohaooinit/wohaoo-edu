define("dojox/color/Colorspace", ["./_base", "dojo/_base/lang", "dojox/math/matrix"],
...
dcolor.Colorspace = new (function(){
	...
	this.tempToWhitepoint=function(/* Number */t){
		if(t<4000){
			0 && console.warn("dojox.color.Colorspace::tempToWhitepoint: can't find a white point for temperatures less than 4000K. (Passed ", t, ").");
			return { x:0, y:0 };
		}
		if(t>25000){
			0 && console.warn("dojox.color.Colorspace::tempToWhitepoint: can't find a white point for temperatures greater than 25000K. (Passed ", t, ").");
			return { x:0, y:0 };
		}
	...
	this.adapt=function(/* Object */kwArgs){
		...
		if(adaptors[kwArgs.adaptor]){
			...
			0 && console.warn("dojox.color.Colorspace::adapt: the passed adaptor '", kwArgs.adaptor, "' was not found.");
		}
	...
	this.convert=function(/* Object */color, /* string */from, /* string */to, /* Object? */kwArgs){
		...
		0 && console.warn("dojox.color.Colorspace::convert: Can't convert ", color, " from ", from, " to ", to, ".");
	};
})();
