...
if (!defined('BACKEND_PLUGIN_NAME_UNDERSCORED')) {
	define('BACKEND_PLUGIN_NAME_UNDERSCORED', basename(dirname(dirname(dirname(__FILE__)))));
}
...
$baseUrl = '/' . str_replace(BACKEND_PLUGIN_NAME_UNDERSCORED . '/js/ckfinder/core/connector/php/connector.php', '', $request->url) . 'files/';
